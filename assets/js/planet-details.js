...
document.addEventListener("DOMContentLoaded", () => {
    ...
    surface: "Mercury is covered with impact craters, cliffs, and ancient rocky plains.",
    magneticField: "Mercury has a weak global magnetic field generated by its partially molten core.",
    satellite: "Mercury has no natural moons.",
    uniqueFeature: "Mercury has the largest temperature variation between day and night of any planet."
}
    ...
    surface: "Its surface contains vast volcanic plains, mountains, and thousands of volcanoes.",
    magneticField: "Venus does not have a strong intrinsic global magnetic field.",
    satellite: "Venus has no natural moons.",
    uniqueFeature: "Venus is the hottest planet in the solar system despite Mercury being closer to the Sun."
}
        },
        ...
        earth: {
            ...
            fact:
                ...
                highlights: {
    worldType: "A water-rich rocky planet with a diverse and active biosphere.",
    surface: "Oceans cover most of the surface, alongside continents, mountains, deserts, and polar regions.",
    magneticField: "Earth's magnetic field protects the planet from much of the charged radiation from the Sun.",
    ...
    surface: "Mars has enormous volcanoes, deep valleys, impact craters, and ancient river channels.",
    magneticField: "Mars does not have a global magnetic field, but parts of its crust retain ancient magnetism.",
    satellite: "Mars has two small moons, Phobos and Deimos.",
    uniqueFeature: "Mars contains Olympus Mons, the largest known volcano in the solar system."
}
        },
    ...
    surface: "Jupiter has no solid surface and gradually transitions from atmosphere into deeper layers.",
    magneticField: "Jupiter has the strongest planetary magnetic field in the solar system.",
    satellite: "Jupiter has a large family of moons, including the four Galilean moons.",
    uniqueFeature: "The Great Red Spot is a gigantic storm that has existed for centuries."
}
        },
        ...
        saturn: {
            ...
            fact:
                ...
                highlights: {
    worldType: "A gas giant surrounded by an extensive system of icy rings.",
    surface: "Saturn has no solid surface and its atmosphere gradually becomes denser with depth.",
    magneticField: "Saturn has a powerful magnetic field generated deep inside the planet.",
    satellite: "Saturn has a large collection of moons, including Titan and Enceladus.",
    uniqueFeature: "Saturn's spectacular rings are made mostly of countless pieces of ice and rock."
}
        },
    ...
    surface: "Uranus has no solid surface and contains deep layers of fluids and gases.",
    magneticField: "Uranus has an unusual magnetic field that is strongly tilted relative to its rotation.",
    satellite: "Uranus has 27 known moons, many named after characters from literature.",
    uniqueFeature: "Uranus rotates on its side with an axial tilt of nearly 98 degrees."
}
        }
...
const planetAxialTilt =
    document.getElementById("planetAxialTilt");

const planetRings =
    document.getElementById("planetRings");
...
const planetFact =
    ...
    const planetWorldType =
    document.getElementById("planetWorldType");

const planetSurface =
    document.getElementById("planetSurface");

const planetMagneticField =
    document.getElementById("planetMagneticField");

const planetSatellite =
    document.getElementById("planetSatellite");

const planetUniqueFeature =
    document.getElementById("planetUniqueFeature");
...
planetRings.textContent = planet.rings;
    ...
    planetFact.textContent =
        ...
        planetWorldType.textContent =
    planet.highlights.worldType;

planetSurface.textContent =
    planet.highlights.surface;

planetMagneticField.textContent =
    planet.highlights.magneticField;

planetSatellite.textContent =
    planet.highlights.satellite;

planetUniqueFeature.textContent =
    planet.highlights.uniqueFeature;
