...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const modalTriggers =
        document.querySelectorAll(".planet-modal-trigger");
    ...
    const modalTitle =
        document.getElementById("planetModalLabel");

    const modalImage =
        document.getElementById("modalPlanetImage");

    const modalType =
        document.getElementById("modalPlanetType");

    const modalDescription =
        document.getElementById("modalPlanetDescription");
        const modalTemperature =    
        document.getElementById("modalPlanetTemperature");

    const modalGravity =
        document.getElementById("modalPlanetGravity");

    const modalMoons =
        document.getElementById("modalPlanetMoons");

    const modalExploreButton =
        document.getElementById("modalExploreBtn");
    ...
    mercury: {
        ...
        venus: {        
            ...
            description:
                "A hot world covered by a thick atmosphere and clouds.",
            temperature: "464°C",
            gravity: "8.87 m/s²",
            moons: "0"
        },  
        ...
        earth: {
            ...
            description:
                "Our home planet and the only known world to support life.",
            temperature: "15°C",
            gravity: "9.81 m/s²",
            moons: "1"
        },
        ...
        uranus: {
            ...
            description:
                "An ice giant with a distinctive blue-green appearance.",
            temperature: "−195°C",
            gravity: "8.69 m/s²",
            moons: "27"
        },
    ...
    modalTriggers.forEach((trigger) => {
        ...
        trigger.addEventListener("click", () => {
            ...
            modalGravity.textContent =
                planet.gravity;

            modalMoons.textContent =
                planet.moons;
            modalExploreButton.href =
                `3-Planets_Details.html?planet=${planetName}`;
...
const comparisonPlanets = [
...

    {
        ...
        type: "TERRESTRIAL PLANET",
        image: "assets/images/planets/Venus.png",
        description: "A hot world covered by thick clouds and extreme conditions.",
        diameter: "12,104 km",
        gravity: "8.87 m/s²",
        temperature: "464°C",
        moons: "0",
...

    {
        ...
        type: "TERRESTRIAL PLANET",
        image: "assets/images/planets/Mars.png",
        description: "The Red Planet, a world of mystery and future possibilities.",
        diameter: "6,779 km",
        gravity: "3.71 m/s²",
        temperature: "-63°C",
        moons: "2",
...

    {
        ...
        type: "GAS GIANT",
        image: "assets/images/planets/Jupiter.png",
        description: "The largest planet in the solar system with powerful storms.",
        diameter: "139,820 km",
        gravity: "24.79 m/s²",
        temperature: "-110°C",
        moons: "95",
...

    {
        ...
        type: "ICE GIANT",
        image: "assets/images/planets/Neptune.png",
        description: "A distant ice giant known for its deep blue color and powerful winds.",
        diameter: "49,244 km",
        gravity: "11.15 m/s²",
        temperature: "-200°C",
        moons: "16",
...
function getPreviousIndex(index) {
    ...
    return (
        index - 1 + comparisonPlanets.length
    ) % comparisonPlanets.length;
...
function updateComparisonPlanet(
    side,
    index,
    direction = 1
) {
    ...
    const description =
        document.getElementById(
            `planet${prefix}Description`
        );

    const counter =
        document.getElementById(
            `planet${prefix}Current`
        );

    const explore =
        document.getElementById(
            `planet${prefix}Explore`
        );
    ...
    const diameter =
        document.getElementById(
            `comparison${prefix}Diameter`
        );

    const gravity =
        document.getElementById(
            `comparison${prefix}Gravity`
        );
    ...
    const moons =
        document.getElementById(
            `comparison${prefix}Moons`
        );

    const day =
        document.getElementById(
            `comparison${prefix}Day`
        );
    ...
    setTimeout(() => {
        ...
        if (explore) {
            ...
            explore.href =
                `3-Planets_Details.html?planet=${planet.key}`;
...
if (planetOnePrev) {
    ...
    planetOnePrev.addEventListener(
        "click",
        () => {
...
if (planetOneNext) {
    ...
    planetOneNext.addEventListener(
        "click",
        () => {
...
if (planetTwoPrev) {
    ...
    planetTwoPrev.addEventListener(
        "click",
        () => {
...
if (planetTwoNext) {
    ...
    planetTwoNext.addEventListener(
        "click",
        () => {
...
const selectorPrev =
    document.getElementById("comparisonSelectorPrev");

const selectorNext =
    document.getElementById("comparisonSelectorNext");
...
const selectLeftPlanet =
    document.getElementById(
        "selectLeftPlanet"
    );

const selectRightPlanet =
    document.getElementById(
        "selectRightPlanet"
    );
...
function setComparisonSelectSide(side) {
    ...
    if (selectLeftPlanet) {
        ...
        selectLeftPlanet.classList.toggle(
            "active",
            side === "one"
        );
    ...
    if (selectRightPlanet) {
        ...
        selectRightPlanet.classList.toggle(
            "active",
            side === "two"
        );
...
if (selectLeftPlanet) {
    ...
    selectLeftPlanet.addEventListener(
        "click",
        () => {
...
if (selectRightPlanet) {
    ...
    selectRightPlanet.addEventListener(
        "click",
        () => {
    ...
    (thumbnail, index) => {
        ...
        thumbnail.addEventListener(
            ...
            () => {
                ...
                if (
                    comparisonSelectSide === "two" &&
                    index === planetOneIndex
                ) {
